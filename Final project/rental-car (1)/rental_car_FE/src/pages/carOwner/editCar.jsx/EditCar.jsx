...
import EditDetail from "../../../components/carOwner/ediCar/EditDetail";
import { useMutation, useQuery } from "@tanstack/react-query";
import {
  editCarInfomationApi,
  getBrandApi,
  getCarFunctionApi,
  getCarType,
  getModelApi,
...
import EditPrice from "../../../components/carOwner/ediCar/EditPrice";
import EditBasicInfomation from "../../../components/carOwner/ediCar/EditBasicInfomation";
...
export default function EditCar({ data, id }) {
  ...
  const { mutate } = useMutation({
    mutationFn: (data) => editCarInfomationApi(data),
    onSuccess: () => {
    ...
    for (const item of images) {
      if (item.file) {
        ...
        const file = new File([blob], `image.png`, {
          type: "image/png", // Đảm bảo rằng MIME type là image/png
        });
