              ...
              >
                <Controller
                  ...
                  render={({ field }) => (
                    ...
                    />
                    // <Editor
                    //   apiKey="YOUR_TINYMCE_API_KEY" // Thêm API key của TinyMCE (nếu có)
                    //   value={field.value} // Giá trị từ React Hook Form
                    //   init={{
                    //     height: 500,
                    //     menubar: false,
                    //     plugins: [
                    ...
                    //   onEditorChange={(content, editor) =>
                    //     field.onChange(content)
                    //   } // Cập nhật giá trị vào React Hook Form khi editor thay đổi
                    // />
                  )}
                />
              </Stack>
